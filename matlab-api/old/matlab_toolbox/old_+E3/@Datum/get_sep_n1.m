function feature_value=get_sep_n1(data)
...
peak_start=str2double(ani.SubjectDetails(strcmpi(ad_names,'sep_n1_start_ms')).Value);
peak_stop=str2double(ani.SubjectDetails(strcmpi(ad_names,'sep_n1_stop_ms')).Value);
