function feature_value=get_sep_n2(data)
%function feature_value=get_sep_n2(data)
...
peak_start=str2double(ani.SubjectDetails(strcmpi(ad_names,'sep_n2_start_ms')).Value);
peak_stop=str2double(ani.SubjectDetails(strcmpi(ad_names,'sep_n2_stop_ms')).Value);
